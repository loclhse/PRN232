        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CategoryId = table.Column<Guid>(type: "uuid", nullable: false),
                    GiftBoxComponentConfigId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-4a3b-8c9d-0e1f2a3b4c5d"), new DateTime(2026, 2, 3, 0, 42, 30, 66, DateTimeKind.Utc).AddTicks(6181), "Guest User", false, "Guest", null },
                    { new Guid("b6a5d4e3-1c2b-4a3d-9e0f-7b6a5c4d3e2f"), new DateTime(2026, 2, 3, 0, 42, 30, 66, DateTimeKind.Utc).AddTicks(6180), "Registered Customer", false, "Customer", null },
                    { new Guid("c5a7d6e8-2f1b-4d3c-9b0a-8c7d6e5f4a3b"), new DateTime(2026, 2, 3, 0, 42, 30, 66, DateTimeKind.Utc).AddTicks(6178), "Staff/Employee", false, "Staff", null },
                    { new Guid("d4b8e7a0-0b6b-4e6a-9a0b-9c8d7e6f5a4b"), new DateTime(2026, 2, 3, 0, 42, 30, 66, DateTimeKind.Utc).AddTicks(6174), "System Administrator", false, "Admin", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e9d8c7b6-a5b4-4c3d-2e1f-0a1b2c3d4e5f"), "", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "staff@happybox.vn", "Nguyen Van Staff", true, false, "$2a$11$SrCgv414CUhk5981tHXzHO10HjV9PClE.MrF0QpzaRXU4kXhaOEpa", "", new Guid("c5a7d6e8-2f1b-4d3c-9b0a-8c7d6e5f4a3b"), null, null, "staff" },
                    { new Guid("f0a1b2c3-d4e5-4f6a-8b9c-0d1e2f3a4b5c"), "", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@happybox.vn", "System Admin", true, false, "$2a$11$5zjt22ugXzlAnWxKSyqoPO2PgXp5YLbi4wqCxDPpKuKx9WMIbOr4.", "", new Guid("d4b8e7a0-0b6b-4e6a-9a0b-9c8d7e6f5a4b"), null, null, "admin" }
                });
