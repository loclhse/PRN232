    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-4a3b-8c9d-0e1f2a3b4c5d"), new DateTime(2026, 1, 29, 9, 27, 9, 637, DateTimeKind.Utc).AddTicks(161), "Guest User", false, "Guest", null },
                    { new Guid("b6a5d4e3-1c2b-4a3d-9e0f-7b6a5c4d3e2f"), new DateTime(2026, 1, 29, 9, 27, 9, 637, DateTimeKind.Utc).AddTicks(159), "Registered Customer", false, "Customer", null },
                    { new Guid("c5a7d6e8-2f1b-4d3c-9b0a-8c7d6e5f4a3b"), new DateTime(2026, 1, 29, 9, 27, 9, 637, DateTimeKind.Utc).AddTicks(157), "Staff/Employee", false, "Staff", null },
                    { new Guid("d4b8e7a0-0b6b-4e6a-9a0b-9c8d7e6f5a4b"), new DateTime(2026, 1, 29, 9, 27, 9, 637, DateTimeKind.Utc).AddTicks(150), "System Administrator", false, "Admin", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e9d8c7b6-a5b4-4c3d-2e1f-0a1b2c3d4e5f"), "", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "staff@happybox.vn", "Nguyen Van Staff", true, false, "$2a$11$SKJY4tjv5Q3AWOW/3nuwoutpM/6XP7WrbBwyDmXxmtSZowyKAWtUq", "", new Guid("c5a7d6e8-2f1b-4d3c-9b0a-8c7d6e5f4a3b"), null, null, "staff" },
                    { new Guid("f0a1b2c3-d4e5-4f6a-8b9c-0d1e2f3a4b5c"), "", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@happybox.vn", "System Admin", true, false, "$2a$11$TN6UaiF9bYdRBLNEysnYp.8d2J.hbIxpKWTXiKappiyHnSUGIz/.K", "", new Guid("d4b8e7a0-0b6b-4e6a-9a0b-9c8d7e6f5a4b"), null, null, "admin" }
                });
